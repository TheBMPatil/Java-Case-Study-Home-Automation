...
public class Oven extends Devices implements KitchenMIF, TemperatureControlDevices {
    private int temperature;
    final int MAX_TEMPERATURE = 300;
    final int TEMPERATURE_INCREMENT = 10;
    final int MIN_TEMPERATURE = 50;
    final int TEMPERATURE_DECREMENT = 10;
    final String[] MODES = {"Off", "Bake", "Broil", "Roast", "Warm"};
    final int[] MODE_TEMPERATURES = {0, 180, 230, 200, 100};
    ...
    public void specialOperations() {
        while (true) {
            System.out.println("Special Operations Menu for Oven:");
